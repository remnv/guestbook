<!-- Modal -->
<div id="addteam" class="modal fade" role="dialog" tabindex="-1" style="z-index:10000;">
  <div class="modal-dialog" role="document">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Team Name's</h4>
      </div>

      <form action="<?php echo base_url('data_master/team_add')?>" method="post">
         ...
         <div class="row form-group">
            <div class="col-sm-9">
              ...
              <tbody>
                <tr>
                  <td>1</td>
                  <td><input type="text" name="nama_team[]" placeholder="example : Dijitrix"></td>
                </tr>
              </tbody>
            </table>
            </div>
