        ...
        <div class="panel-body">
          ...
          <!-- Biar responsive ketika di layar kecil -->
            ...
            <div class="box-header">
              <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addteam" style="margin-bottom:2%"><span class="glyphicon glyphicon-plus"></span>Add</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php $this->load->view('data_master/team_add');?>
